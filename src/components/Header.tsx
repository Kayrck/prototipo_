      ...
      <div className="bg-[#C41230] text-white text-sm no-print">
        <div className="max-w-[1280px] mx-auto px-6 lg:px-8 flex items-center justify-between h-9">
          <div className="flex items-center gap-4">
            <a
              href="mailto:contato@sintfub.org.br"
            ...
            >
              ...
              <span className="hidden sm:inline">contato@sintfub.org.br</span>
            </a>
            <a
              href="https://api.whatsapp.com/send?phone=5561XXXXXXXXX&text=Ol%C3%A1!%20Gostaria%20de%20falar%20com%20o%20SINTFUB."
              target="_blank"
            ...
            >
              ...
              <span className="hidden sm:inline">(61) XXXX-XXXX</span>
            </a>
          </div>
          <div className="flex items-center gap-3">
            <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" aria-label="Facebook do SINTFUB" className="hover:text-red-200 transition-colors">
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
            </a>
            <a href="https://youtube.com" target="_blank" rel="noopener noreferrer" aria-label="YouTube do SINTFUB" className="hover:text-red-200 transition-colors">
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M23.498 6.186a3.016 3.016 0 00-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 00.502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 002.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 002.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>
            </a>
            <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" aria-label="Instagram do SINTFUB" className="hover:text-red-200 transition-colors">
      ...
      >
        <div className="max-w-[1280px] mx-auto px-6 lg:px-8">
          <div className="flex items-center h-16 lg:h-20 gap-6">
            ...
            {/* Desktop Nav */}
            <nav className="hidden lg:flex items-center gap-0 ml-4 flex-1" aria-label="Navegação principal">
              {menuItems.map((item) => (
            ...
            <div className="flex items-center gap-2 ml-auto">
              ...
              <Link
                to="/filie-se/"
                className="hidden sm:flex items-center gap-2 bg-[#C41230] hover:bg-[#9B0E25] text-white text-sm font-bold px-4 py-2 rounded-lg transition-colors"
              >
          ...
          >
            ...
            <div className="p-4 border-t border-gray-100 space-y-2">
              ...
              <div className="flex items-center justify-center gap-4 pt-1">
                <a href="mailto:contato@sintfub.org.br" className="text-gray-500 hover:text-[#C41230] text-xs transition-colors">
                  contato@sintfub.org.br
                </a>
              </div>
            </div>
          </nav>
