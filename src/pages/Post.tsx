        ...
        <div className="flex gap-10">
          ...
          <div className="hidden xl:flex flex-col items-center gap-2 pt-2 sticky top-24 h-fit" aria-label="Compartilhar verticalmente">
            ...
            {[
              ...
              { label: "Twitter", path: "M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.74l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" },
              ...
              <button
                ...
                className="w-9 h-9 bg-gray-100 hover:bg-[#C41230] hover:text-white text-gray-600 rounded-lg flex items-center justify-center transition-colors"
            ...
            <div className="p-5">
              <div className="grid grid-cols-4 gap-3 mb-5">
                {shareNetworks.map((net) => (
                  <button
                    key={net.label}
                    className="group flex flex-col items-center gap-2 p-3 rounded-xl border border-gray-100 hover:border-[#C41230] transition-colors"
                    aria-label={`Compartilhar no ${net.label}`}
                  >
                    <div className="w-8 h-8 rounded-full flex items-center justify-center bg-gray-100 group-hover:bg-[#C41230] transition-colors">
                      <span className="text-xs font-bold text-gray-700 group-hover:text-white transition-colors">{net.label[0]}</span>
                    </div>
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className={`flex-shrink-0 px-4 py-2 rounded-lg text-sm font-bold transition-colors ${
                    copied ? "bg-gray-900 text-white" : "bg-[#C41230] hover:bg-[#9B0E25] text-white"
                  }`}
                >
