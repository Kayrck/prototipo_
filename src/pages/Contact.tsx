                ...
                <div key={dept.label} className="p-4 bg-gray-50 rounded-xl border border-gray-100">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <a
                      ...
                      className="flex items-center gap-2 text-xs text-gray-600 hover:text-[#C41230] transition-colors"
                    >
                      <svg className="w-3.5 h-3.5 text-[#C41230]" viewBox="0 0 24 24" fill="currentColor">
              ...
              <div className="space-y-5">
                ...
                <div>
                  <label htmlFor="c-message" className="block text-sm font-medium text-gray-700 mb-1.5">
                    Mensagem <abbr title="obrigatório" className="ml-1 text-[#C41230] no-underline">*</abbr>
                  </label>
                  <textarea
